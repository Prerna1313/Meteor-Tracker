  ...
  return (
    ...
    >
      ...
      <div className="relative flex flex-col items-center text-center">
        <h1 className="text-4xl font-light tracking-[0.3em] text-white/70">EYES</h1>
        <h2 className="mt-2 text-lg font-light tracking-[0.4em] text-white/50">ON</h2>
        <h1 className="mt-4 text-5xl font-medium tracking-[1em] text-white">METEORS</h1>
      </div>
